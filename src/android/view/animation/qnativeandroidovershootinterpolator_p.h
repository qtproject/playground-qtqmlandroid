...
class QNativeAndroidOvershootInterpolatorPrivate;
...
private:
    Q_DISABLE_COPY(QNativeAndroidOvershootInterpolator)
    Q_DECLARE_PRIVATE(QNativeAndroidOvershootInterpolator)
};
