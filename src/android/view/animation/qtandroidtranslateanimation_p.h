#ifndef QTANDROIDTRANSLATEANIMATION_P_H
#define QTANDROIDTRANSLATEANIMATION_P_H

#include "qtandroidanimation_p.h"

QT_BEGIN_NAMESPACE

class QtAndroidTranslateAnimation : public QtAndroidAnimation
{
    Q_OBJECT
...
public:
    explicit QtAndroidTranslateAnimation(QObject *parent = 0);
...
#endif // QTANDROIDTRANSLATEANIMATION_P_H
